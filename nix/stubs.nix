...
# ==============================================================================
#
# Evaluates NixOS and Home Manager option trees in pure Nix, then uses tix-cli
# --from-json to convert the JSON into .tix stub files. This avoids needing
# `nix eval --impure` inside the build sandbox.
#
